...
import { VaultToken as VaultTokenContract } from "../types/Factory/VaultToken";
import { VaultToken as VaultTokenTemplate, Pair as PairTemplate } from "../types/templates";
...
export function updateLendingPoolUSD(pairAddress: String): void {
    ...
    factory.totalBalanceUSD = factory.totalBalanceUSD.plus(lendingPool.totalBalanceUSD).minus(prevTotalBalanceUSD);
    factory.totalSupplyUSD = factory.totalSupplyUSD.plus(lendingPool.totalSupplyUSD).minus(prevTotalSupplyUSD);
    factory.totalBorrowsUSD = factory.totalBorrowsUSD.plus(lendingPool.totalBorrowsUSD).minus(prevTotalBorrowsUSD);
    factory.save();
}
