...
import { LendingPoolInitialized } from "../types/Factory/Factory";
import { FACTORY_ADDRESS } from "./constants";
import { Factory, LendingPool, Collateral, Borrowable } from "../types/schema";
...
export function handleLendingPoolInitialized(event: LendingPoolInitialized): void {
    ...
    if (factory === null) {
        ...
        factory.totalBalanceUSD = ZERO_BD;
        factory.totalSupplyUSD = ZERO_BD;
        factory.totalBorrowsUSD = ZERO_BD;
    }
    factory.save();
