import { Sync, NewSafetyMargin, NewLiquidationIncentive, Transfer } from "../types/templates/Collateral/Collateral";
import { Collateral } from "../types/schema";
import { convertTokenToDecimal, BI_18, fetchCollateralExchangeRate, updateLendingPoolUSD, loadOrCreateCollateralPosition } from "./helpers";
